/**
 * Loads the active Cloud project id from the server (GET /project_info)
 * once at startup and caches the result. Needed to build the fully-
 * qualified model resource name sent on /start.
 */
 ...
 * cached value without re-fetching. Returns `null` if the fetch fails.
 */
